...
// Accessible feature modal dialog built on canonical native <dialog> foundation.
...
export function Modal({ open, onClose, title, children, size = 'md' }: ModalProps) {
  ...
  return (
    <Dialog
      ...
      onClose={onClose}
      aria-label={title}
      className={`w-full ${sizeStyles[size]} rounded-xl bg-white shadow-xl outline-none backdrop:bg-black/50 p-0`}
    >
      {/* Header */}
